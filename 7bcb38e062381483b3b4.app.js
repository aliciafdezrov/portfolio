...
/******/ 		return __webpack_require__.p + "" + "7bcb38e062381483b3b4" + "." + ({"4":"vendors~pdfjsWorker"}[chunkId]||chunkId) + ".js"
/******/ 	}
/******/
        ...
        return (React.createElement("div", { className: "central-div" },
            React.createElement(react_md_1.Paper, { className: "title-paper white-background", zDepth: 2 },
                React.createElement("div", { className: "row" },
                    ...
                    React.createElement("div", { className: "col-lg-6 col-md-6 col-sm-12 col-xs-12 avatar-style" },
