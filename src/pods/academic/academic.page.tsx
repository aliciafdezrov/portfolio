			...
			<BrowserView>
				<div className={classes.container}>
					<div className={classes.card}>
							...
							<div>
								...
								<div className={classes.stepsStyle}>
									<Steps vertical current={currentStudiesStep}
										...
										<Steps.Item title={<h5 style={{color: 'white'}}>Sept 2013 - Sept 2017</h5>}
																description={<span style={{color: 'white'}}>Grado Ingeniería de la Salud (Universidad de Málaga)</span>}/>
									</Steps>
								</div>
							</div>
						</Reveal>
                      ...
                      title={<h5 style={{color: 'white'}}>Seminario en optimización para la reconstrucción de redes génicas (Universidad de Málaga) (2015)</h5>}
                      description={<span style={{color: 'white'}}>Asistencia a un seminario proporcionado por la Universidad de Málaga 2015(3 meses)
                                                        Seminario realizado con una duración de tres meses relacionado con la optimización en la reconstrucción de redes génicas haciendo uso de metaheurística</span>}/>

										<Steps.Item title={<h5 style={{color: 'white'}}>Desarrollo de una aplicación Android (Universidad de Málaga) (2016)</h5>}
