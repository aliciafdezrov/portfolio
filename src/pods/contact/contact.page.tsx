                    ...
                    <div className={classes.wrapper}>
                        <div>
                            <div>
                                ...
                                <Divider/>
                                <p>Llevo desde 2016 formándome como desarrolladora. A lo largo de estos años he
                                    aprendido un poco más sobre que busco profesionalmente y estos son mis mandamientos:
                                    <ul>
                    ...
                    <div className={classes.wrapper}>
                        <div className={classes.contactTextDiv}>
                            ...
                            <p>Llevo desde 2016 formándome como desarrolladora. A lo largo de estos años he aprendido un
                                poco más sobre que busco profesionalmente y estos son mis mandamientos:
                                <ul>
